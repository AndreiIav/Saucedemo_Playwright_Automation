...
test('Checkout Step One Page name is "Checkout: Your Information"',
    async ({ page }) => {
        const inventoryPage = new InventoryPage(page);
        const headerPage = new HeaderPage(page);
...
test('Checkout Step Two Page name is "Checkout: Overview"',
    async ({ page }) => {
        const inventoryPage = new InventoryPage(page);
        const headerPage = new HeaderPage(page);
        const cartPage = new CartPage(page);
...
test('Checkout Complete Page name is "Checkout: Complete!"',
    async ({ page }) => {
        const inventoryPage = new InventoryPage(page);
        const headerPage = new HeaderPage(page);
        const cartPage = new CartPage(page);
